...
export default function QrRsvpPostcard({
  brideFullName,
  groomFullName,
  first,
  second,
      ...
      <div className="relative flex h-full w-full items-center gap-4 px-[6mm] sm:gap-7 sm:px-[11mm]">
        ...
        <div className="-rotate-1 rounded-lg bg-white p-[3mm] shadow-md">
          {qrDataUrl ? (
            ...
            <img src={qrDataUrl} alt="QR code linking to the RSVP page" className="block h-[26mm] w-[26mm] sm:h-[36mm] sm:w-[36mm]" />
          ) : (
