...
const GEOMETRY: Record<CarouselEffect, EffectGeometry> = {
  fan: {
    rest: [
      ...
      { x: 18, y: 0, rotate: 5, scale: 0.95, opacity: 1, zIndex: 20 },
      { x: -20, y: 0, rotate: -6, scale: 0.88, opacity: 0.7, zIndex: 10 },
      { x: 0, y: 0, rotate: 0, scale: 0.8, opacity: 0, zIndex: 0 },
    ],
    inTop: { x: 6, y: 0, rotate: 7, scale: 1.03, opacity: 0, zIndex: 30 },
    outTop: { x: -80, y: 0, rotate: -5, scale: 1, opacity: 0, zIndex: 40 },
    outBack: { x: -46, y: 0, rotate: -8, scale: 0.72, opacity: 0, zIndex: 0 },
  },
  flip: {
    rest: [
      { x: 0, y: 0, rotateY: 0, scale: 1, opacity: 1, zIndex: 30, ...P },
      { x: 14, y: 0, rotateY: 12, scale: 0.95, opacity: 1, zIndex: 20, ...P },
      { x: -16, y: 0, rotateY: -16, scale: 0.9, opacity: 0.7, zIndex: 10, ...P },
      { x: 0, y: 0, rotateY: 20, scale: 0.8, opacity: 0, zIndex: 0, ...P },
    ],
    inTop: { x: 4, y: 0, rotateY: -30, scale: 1.03, opacity: 0, zIndex: 30, ...P },
    outTop: { x: -74, y: 0, rotateY: 35, scale: 1, opacity: 0, zIndex: 40, ...P },
    outBack: { x: -42, y: 0, rotateY: -24, scale: 0.72, opacity: 0, zIndex: 0, ...P },
  },
  swirl: {
    rest: [
      { x: 0, y: 0, rotate: 0, scale: 1, opacity: 1, zIndex: 30 },
      { x: 16, y: 0, rotate: 7, scale: 0.95, opacity: 1, zIndex: 20 },
      { x: -18, y: 0, rotate: -8, scale: 0.88, opacity: 0.7, zIndex: 10 },
      { x: 0, y: 0, rotate: 20, scale: 0.8, opacity: 0, zIndex: 0 },
    ],
    inTop: { x: 4, y: 0, rotate: -30, scale: 1.04, opacity: 0, zIndex: 30 },
    outTop: { x: -76, y: 0, rotate: 40, scale: 1.02, opacity: 0, zIndex: 40 },
    outBack: { x: -44, y: 0, rotate: -32, scale: 0.72, opacity: 0, zIndex: 0 },
  },
};
